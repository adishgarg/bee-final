    ...
    <div className="bg-white border-2 border-black shadow-md overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex flex-col justify-between flex-grow">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-2 sm:space-y-0">
          ...
          <button
            // onClick={onAddToCart}
            className="cart-button w-full sm:w-auto bg-white text-black font-semibold border border-black px-4 py-2 hover:bg-black hover:text-white transition-colors duration-300"
          >
            Add to Cart
          </button>
        </div>
